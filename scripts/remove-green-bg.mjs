...
async function removeBackground() {
  console.log('🧼 Starting green-screen background removal and resizing on asset PNGs...');
      ...
      return new Promise((resolve) => {
        ...
        img.onload = () => {
          ...
          for (let i = 0; i < data.length; i += 4) {
            ...
            if (g > 120 && r < 120 && b < 120 && g > r + 30 && g > b + 30) {
          ...
          resizedCtx.drawImage(canvas, 0, 0, 128, 128);
